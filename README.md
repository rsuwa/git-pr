...
```bash
curl -fsSL https://github.com/rsuwa/git-pr/releases/download/v0.3.4/install.sh |
  env \
    GIT_PR_INSTALL_URL="https://github.com/rsuwa/git-pr/releases/download/v0.3.4/git-pr" \
    GIT_PR_CHECKSUM_URL="https://github.com/rsuwa/git-pr/releases/download/v0.3.4/SHA256SUMS" \
    bash
```
...
```bash
GIT_PR_UPDATE_URL="https://github.com/rsuwa/git-pr/releases/download/v0.3.4/git-pr" \
GIT_PR_UPDATE_CHECKSUM_URL="https://github.com/rsuwa/git-pr/releases/download/v0.3.4/SHA256SUMS" \
  git pr update
```
...
The current `v0.3.4` release is published with all three assets.

Verify a release before using it:

```bash
gh release view v0.3.4 --json tagName,isDraft,isPrerelease,assets
curl -fsSL https://github.com/rsuwa/git-pr/releases/download/v0.3.4/SHA256SUMS
```
